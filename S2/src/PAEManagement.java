...
public class PAEManagement {
    public static void main(String ...args) {
        try {
            Person prof1 = new Person("Thérence", "Guerenne-Courtois", Person.genderEnum.F,2003,10,21);
            Person prof2 = new Person("Martin", "Giroux", Person.genderEnum.F,2001,2,19);
            Person prof3 = new Person("Pierre-Lou", "Nihoul", Person.genderEnum.M,2001,2,19);
            ...
            Student student =  new Student("Pierre", "Legrand", Person.genderEnum.M, 2003, 10, 21, Student.sectionNameEnum.info, Student.studyYearNumberEnum.second);
